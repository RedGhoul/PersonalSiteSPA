                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <ul className="info">
                                    <li><span className="first-block">Full Name:</span><span className="second-block">Avaneesa Basappa</span></li>
                                    <li><span className="first-block">Email:</span><span className="second-block">avaneesab5gmail.com</span></li>
                                    <li><span className="first-block" >Blog:</span><span className="second-block"><a href="http://somethings.blog" target="_blank" style={{ color: 'black' }}>www.somethings.blog</a></span></li>
                                </ul>
                            </div>
